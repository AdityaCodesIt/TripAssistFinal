...
INSERT INTO public.tourist_spots (name, location, category, description, latitude, longitude, rating, cost_level) VALUES
('Central Park', 'New York City, NY', 'Park', 'A large public park in Manhattan', 40.7829, -73.9654, 4.5, 'Free'),
('Golden Gate Bridge', 'San Francisco, CA', 'Landmark', 'Iconic suspension bridge', 37.8199, -122.4783, 4.7, 'Free'),
('Statue of Liberty', 'New York City, NY', 'Monument', 'Symbol of freedom and democracy', 40.6892, -74.0445, 4.6, 'Medium')
